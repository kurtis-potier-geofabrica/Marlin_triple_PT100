 ...
 */
#define THERMOCOUPLE_MAX_ERRORS 150
 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 160        // Seconds
  #define THERMAL_PROTECTION_HYSTERESIS 80     // Degrees Celsius
...
#define MAX_CONSECUTIVE_LOW_TEMPERATURE_ERROR_ALLOWED 6
